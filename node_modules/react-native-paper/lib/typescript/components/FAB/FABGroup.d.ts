...
declare const _default: React.ComponentType<Pick<Props, "style" | "color" | "onPress" | "testID" | "accessibilityLabel" | "icon" | "visible" | "open" | "variant" | "actions" | "fabStyle" | "onStateChange" | "backdropColor"> & {
...
declare const FABGroupWithTheme: React.ComponentType<Pick<Props, "style" | "color" | "onPress" | "testID" | "accessibilityLabel" | "icon" | "visible" | "open" | "variant" | "actions" | "fabStyle" | "onStateChange" | "backdropColor"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<unknown> | undefined;
}> & import("@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<React.ComponentType<Props> & {
    ({ actions, icon, open, onPress, accessibilityLabel, theme, style, fabStyle, visible, testID, onStateChange, color: colorProp, variant, backdropColor: customBackdropColor, }: Props): JSX.Element;
    displayName: string;
